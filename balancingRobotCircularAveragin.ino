...
#define ACC_SAMPLES   32      //number of times to sample accelerometer (max 255)
#define PID_SAMPLES   64      //number of times to sample pid (max 255)

#define MIN_HALFPULSE 20      //minimum halfpulse
#define MAX_PID       8192    //maximum expected pid

#define KP            2          //proportion
#define KD            -100       //derivative

#define DEAD_ZONE 80
#define FALL_ZONE 650

uint32_t loop_counter = 0;      //how many loops have we done?

int16_t ax;                     //current acceleration
    ...
    if ((loop_us - lastpulse_us) >= halfpulse_us) { //time to step the motors
     ...
     switch (loop_counter & 0x0f){
        ...
        case 4:
            ...
            if ((avg_acc > -DEAD_ZONE && avg_acc < DEAD_ZONE) || (avg_acc < -FALL_ZONE || avg_acc > FALL_ZONE)){
                dir = 0;
                pid_arr[pid_arr_p] = 0;
            ...
            halfpulse_us = MIN_HALFPULSE + MAX_PID / avg_pid;
