...
#define MIN_HALFPULSE 60  //116                    //minimum halfpulse
#define MAX_PID   131078 //12288     //maximum expected pid

#define TARGET  0                     //target angle

#define KP      0.2 //proportion
#define KD      0.15        //derivative

#define DEBUG   0        //debug mode (serial output) mode 0 = no mode

#define DEAD_ZONE 0
#define FALL_ZONE 850   
#define FULL_POWER_ZONE 900
...
void loop() {
    ...
    switch (loop_counter & 0x0f) {
        ...
        case 4:
            ...
            if (avg_acc < -FULL_POWER_ZONE || avg_acc > FULL_POWER_ZONE) halfpulse_us = 140;
